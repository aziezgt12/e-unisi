...
<head>
  ...
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?= base_url() ?>asset/js/style.css">
  <link rel="stylesheet" href="<?= base_url() ?>asset/js/components.css">
</head>
    ...
    <section class="section">
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            <img src="https://unisi.ac.id/wp-content/uploads/2018/10/cropped-LOGOUNS-1.png " alt="logo" class="shadow-light mb-5 mt-2">
            ...
            <form method="POST"  action="<?= base_url('index.php/auth/login') ?>" class="needs-validation" novalidate="">
              <div class="form-group">
                ...
                <input id="email" type="email" class="form-control" name="identity" tabindex="1" required autofocus>
...
<!--             <div class="text-center mt-5 text-small">
  ...
  <script src="<?= base_url('assets/js/nicescroll.min.js') ?>"></script>
