            ...
            <tbody>
              ...
              <tr style="text-transform: capitalize;">
                ...
                <td width="150" align="center">
                  <a href="<?= base_url('C_Alumni/det_alumni/'.$value->nim) ?>" class="btn btn-primary btn-sm"><span class="fa fa-eye"></span> Lihat Detail</a>
                  <a href="<?= base_url('C_Tracer/hasil/'.$value->nim) ?>" class="btn btn-danger btn-sm"><span class="fa fa-eye"></span> Lihat Tracer</a>
                </td>
              </tr>              
            <?php endforeach ?>
            </tbody>
