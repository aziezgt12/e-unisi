...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2021 at 08:29 AM
...
(2, '::1', 'aziz', '$2y$10$fbcjofBaZz8uhuQROPZPleG8OWP7SyzBr9vuH9do8vyoa0LPS6vp2', 'aziezgt12@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1633851115, 1636266670, 1, 'aziz', 'aziz', 'aziz', '082386340464');
...
--
ALTER TABLE `tbl_berkas_wisuda`
  MODIFY `berkasID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `tbl_form_c2`
  MODIFY `c2ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
